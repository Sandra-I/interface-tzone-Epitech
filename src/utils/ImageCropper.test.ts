...
describe('imageCropper', () => {
  ...
  it('should get specific image after being cropped', () => {
    ...
    ImageCropper.cropImage(imgUrl, cropSelection).then((result) => {
      expect(result).toBe(croppedImgUrl);
    });
  });
  ...
  it('should call multiple functions', () => {
    ...
    ImageCropper.sendImage(ctx, img, selection, canvas);
